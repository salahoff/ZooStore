...
namespace GameStore.WebUI.Controllers
{
    ...
    public class ShoppingCartController : Controller
    {
        ...
        public ActionResult PlaceOrder(CheckoutViewModel value)
        {
            ...
            //{
            //    ViewBag.Message = "Укажите действующий адрес доставки!";
            ...
            {
                ViewBag.Message = "Возникла ошибка:" + ex.Message;
            }
        ...
        //        switch (StatusCode)
        //        {
        //            case ("A"): ViewBag.TransactionStatus = "Сделка одобрена! Ваш заказ создан!"; break;

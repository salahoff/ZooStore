    ...
    public class UserController : BaseApiController
    {
        ...
        public HttpResponseMessage Post([FromBody]UserViewModel value)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, "Пользователь [" + value.Id + "] не существует!");
                }
        ...
        public HttpResponseMessage Delete(string id)
        {
            ...
            if (user == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK, "Пользователь ["+id+"] не найден.");
            }            
            else
            {
